...
export const boxLetterStyles = cva(
  'w-12 h-12 grid place-items-center font-extrabold text-lg rounded-lg uppercase',
  {
    variants:{
      status: {
        initial: 'bg-gray-500/20 text-gray-500 dark:bg-gray-600/40 dark:text-gray-200',
        ...
        absent: 'border border-slate-400 bg-slate-200 text-slate-700 dark:bg-slate-500/40 dark:text-slate-300'
      }
    },
    defaultVariants: {
      status: 'initial'
